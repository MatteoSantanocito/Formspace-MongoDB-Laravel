...
<main>
        <div class="container">
         <div class="left">
             ...
             <div class= "sidebar">
               <a class="menu-item" id="Home" href="<?php echo e(route('home')); ?>">
                   <span><i class="uil uil-house-user"></i></span><h3>Home</h3>
               </a>

               <a class="menu-item active" id="profile" href="<?php echo e(route('profile')); ?>">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/hw2/resources/views/profile.blade.php ENDPATH**/ ?>